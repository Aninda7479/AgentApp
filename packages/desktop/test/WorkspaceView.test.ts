...
import { composerModelsFromCatalog, composerEmptyStateMessage } from '../src/renderer/pages/Workspace/WorkspaceView.js';
import type { ModelConfig } from '../src/renderer/logic/types.js';
