...
/**
 * Manages custom micro-apps / artifacts in ~/.superagent/artifact/<artifact-id>
 */
export class ArtifactManager extends EventEmitter {
  ...
  constructor(customDir?: string) {
    super();
    this.baseDir = customDir || path.join(os.homedir(), '.superagent', 'artifact');
  }
  ...
  /**
   * Scans ~/.superagent/artifact for artifact manifests and loads states.
   */
