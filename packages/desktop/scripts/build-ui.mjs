...
try {
  ...
  if (fs.existsSync(srcCss)) {
    ...
    console.log('[build-ui] Copied raw src/index.css to dist/index.css.');
  }
}
...
const htmlFiles = [
  ...
  { src: 'src/index.html', dest: 'dist/ui.html' }, // backward compatibility
...
if (isWatch) {
  ...
  console.log('[build-ui] ✅ Desktop UI build finished.');
}
