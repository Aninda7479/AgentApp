    ...
    pub fn curated_catalog(&self) -> Vec<VideoModelInfo> {
        vec![
            ...
            VideoModelInfo {
                ...
                name: "Wan 2.1 3D-VAE (Spatial-Temporal Decoder)".to_string(),
                family: VideoModelFamily::Wan2_1,
                modality: VideoModality::Both,
                quantization: "FP16".to_string(),
                download_url: "https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/vae/wan_2.1_vae.safetensors".to_string(),
                filename: "wan_2.1_vae.safetensors".to_string(),
                size_bytes: 254_000_000,
            ...
            VideoModelInfo {
                ...
                name: "UMT5-XXL Text Conditioning Encoder (Q4)".to_string(),
                family: VideoModelFamily::Wan2_1,
                modality: VideoModality::TextToVideo,
                quantization: "Q4_K_M".to_string(),
                download_url: "https://huggingface.co/city96/umt5-xxl-encoder-gguf/resolve/main/umt5-xxl-encoder-Q4_K_M.gguf".to_string(),
                filename: "umt5-xxl-encoder-Q4_K_M.gguf".to_string(),
