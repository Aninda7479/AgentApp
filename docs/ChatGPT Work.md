...
## 2. GPT-5.6 Model Family

ChatGPT Work is powered by the **GPT-5.6** model family, which consists of three core variants tailored for specific speed, reasoning, and cost requirements:

1.  **Sol**: The flagship reasoning model. Optimized for complex programming tasks, security reviews, mathematical problem-solving, and intensive data-driven research.
2.  **Terra**: The balanced productivity model. Handles general business logic, writing, standard scripting, data parsing, and file formatting tasks.
3.  **Luna**: The lightweight and fastest model. Perfect for quick conversational Q&As, basic text editing, text summarization, and high-speed automated responses.
